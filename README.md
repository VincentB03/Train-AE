...
[download_wandb_weights.py](download_wandb_weights.py) fetches the AE and/or flow checkpoints of a W&B run into `wandb_weights/`, in the layout `load_galaxy_autoencoder` / `load_flow` expect:
